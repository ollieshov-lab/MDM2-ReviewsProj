...
DOCUMENT_FILE = os.path.join(DATA_DIR, "Hotel_Document_Info.csv")
BENCHMARK_FILE= os.path.join(DATA_DIR, "Hotel_Hotel_vs_City_Benchmark.csv")
ADVICE_FILE   = os.path.join(DATA_DIR, "Hotel_Hotel_Advice.csv")
...
def build_detail(semantic_label, hotel_df, benchmark_df, advice_df):
    ...
    # Tabs
    tab_trends, tab_city, tab_reviews = st.tabs(["Trends", "City Comparison", "Guest Reviews"])
