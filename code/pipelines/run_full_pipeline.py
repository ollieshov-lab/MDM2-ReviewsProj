...
NOTEBOOK_PATH = "code/notebooks/Main_Full_Pipeline.ipynb"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Execute the migrated main RP notebook via a canonical Python entrypoint."
    )
    parser.add_argument(
        "--executed-notebook-output",
        default="outputs/intermediate/notebook_runs/Main_Full_Pipeline.executed.ipynb",
