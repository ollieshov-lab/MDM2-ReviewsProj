...
NOTEBOOK_PATH = "code/notebooks/statistical_tests.ipynb"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Execute the migrated RP statistical-tests notebook via a canonical Python entrypoint."
    )
    parser.add_argument(
        "--executed-notebook-output",
        default="outputs/intermediate/notebook_runs/statistical_tests.executed.ipynb",
