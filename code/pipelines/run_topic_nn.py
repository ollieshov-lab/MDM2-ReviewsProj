...
NOTEBOOK_PATH = "code/notebooks/topic_nn.ipynb"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Execute the migrated RP topic-neural-network notebook via a canonical Python entrypoint."
    )
    parser.add_argument(
        "--executed-notebook-output",
        default="outputs/intermediate/notebook_runs/topic_nn.executed.ipynb",
